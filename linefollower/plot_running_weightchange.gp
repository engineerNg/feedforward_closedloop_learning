...
#
plot 'flog.tsv' using ($0):16 with lines title 'weight layer1', \
     'flog.tsv' using ($0):17 with lines title 'weight layer2', \
     'flog.tsv' using ($0):18 with lines title 'weight layer_output'
